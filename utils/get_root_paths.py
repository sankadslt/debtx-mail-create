...
def get_project_root():
    ...
    """
    return Path(__file__).resolve().parent.parent  # Adjust the number of parent directories as needed
...
def get_config_filePath():    
    ...
    config_file_path = project_root / "config" / "core_config.ini"
...
def get_logger_filePath():    
    ...
    logger_file_path = project_root / "config" / "logger.ini"
